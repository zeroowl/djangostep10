...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('step10_userprofile', (
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('clean_start_time', self.gf('django.db.models.fields.DateField')()),
            ('country', self.gf('django.db.models.fields.TextField')(max_length=128)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('step10', ['UserProfile'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'UserProfile'
        db.delete_table('step10_userprofile')
    ...
    models = {
        ...
        'step10.userprofile': {
            ...
            'clean_start_time': ('django.db.models.fields.DateField', [], {}),
            'country': ('django.db.models.fields.TextField', [], {'max_length': '128'}),
